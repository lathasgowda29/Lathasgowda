...
function AboutHeroSection() {
  return (
    <section className="mx-auto flex w-full max-w-[1120px] items-center gap-[88px] px-4 pt-[62px]">
      {/* Profile image — left side */}
      <div className="h-[682px] w-[516px] shrink-0 overflow-hidden rounded-[24px]">
        <img
          src={imgProfile}
          alt="Latha"
      ...
      <div className="flex flex-col gap-[20px]">
        <div className="flex flex-col gap-[20px]">
          <h1 className="font-geist text-[48px] font-semibold leading-[54px] text-dark">
            I'm Latha !
          </h1>
...
function DesignJourneySection() {
  return (
    <section className="mx-auto flex w-full max-w-[1120px] gap-[80px] px-4 pb-[120px] pt-[120px]">
      {/* Left: Intro text */}
      <div className="w-[300px] shrink-0">
        <h2 className="font-geist text-[34px] font-semibold leading-[44px] tracking-[0.25px] text-dark">
      ...
      <div className="relative flex-1 min-h-[724px]">
        <img
          src={imgAboutDesignJourney}
          alt="Design journey at Yellow.ai — Intern to Sr. Product Design"
          className="h-full w-full max-w-[708px] object-contain"
        />
      </div>
    </section>
  );
...
function AboutAchievementCardsSection() {
  ...
  return (
    <section className="relative mx-auto h-[960px] w-[1280px] max-w-full overflow-hidden px-4">
...
function AboutCtaSection() {
  return (
    <section className="mx-auto w-full max-w-[1120px] px-4 py-[80px]">
      <div className="flex h-[276px] w-full flex-col justify-center rounded-[24px] bg-teal-dark px-10">
...
function AboutFooter() {
  return (
    <footer className="mx-auto w-full max-w-[1120px] px-4 pb-[40px]">
      ...
      <div className="flex items-center px-4 pt-[40px]">
    ...
    <div className="min-h-screen bg-white">
      <div className="w-full px-4 pt-4">
        <div className="relative w-full min-h-[926px] rounded-t-[24px] bg-cream">
          <div className="relative min-h-[920px] px-4 pt-4">
            <div className="pt-6">
              <Navbar />
            </div>
